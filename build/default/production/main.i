...
# 408 "./mcc_generated_files/tmr1.h"
...
void fluxcontrol(){
    ...
    if(error > 150 || error < 150){
        ...
        else if(outputsum <-200) outputsum = -200;
        outpre = ((kpf*error + outputsum)/100);
        if (outpre > 430) output = 430;
...
void pwmcontrol(){
    ...
    if(error > 150 || error < 150){
        outputsum += ((kip*timecontrol*error)/100000);
        if (outputsum > 102300) outputsum = 102300;
        else if (outputsum< -20000) outputsum = -20000;
        outpre = (kpp*error + outputsum + (kpp*(error - errorp))/100);
...
void fluxpos(){
    if(controlchoice==2) flux = output - position;
    else{
    ...
    switch(bufferRx[0]){
        case 0x00:
            if(countRx==7){
                ...
                vRx.vL = bufferRx[4];
                sp_position = vRx.v;
                if(sp_position > 430 ) sp_position = 430;
